...
class Scratch3IoTBlocks{
    constructor(runtime){
        ...
        this.prefix="yarila682@yandex.ru/"
        this.bport = null;
        this.baddr = null;
        this.last_messages = {};
        this.options = {};
        ...
        this.topics_enum = {air:'a', dis:'b', lux:'c',tem:'d', hum:'e'};
        this.data_sensors = {
            air: -1,
            distance: -1,
            lux: -1,
    ...
    iot_mess_to_topic(args){
        if(this.runtime.IOT.client == undefined){
            ...
            console.log("mess_to_topic.args" + args + "; <baddr, bport> = <" + topic + ", " + args.MESSAGE + ">");
            this.runtime.IOT.client.publish(topic, args.MESSAGE);
        }
        return;
    }
