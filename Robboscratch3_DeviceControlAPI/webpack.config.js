...
const base = {
    ...
    output: {
        library: 'Robboscratch3_DeviceControlAPI',
        filename: '[name].js'
    },
    module: {
        rules: [{
...
module.exports = [
    ...
    defaultsDeep({}, base, {
        target: 'web',
        entry: {
            'Robboscratch3_DeviceControlAPI': './src/index.js',
            'Robboscratch3_DeviceControlAPI.min': './src/index.js'
        },
        output: {
            libraryTarget: 'umd',
            ...
            rules: base.module.rules.concat([
                {
                    ...
                    loader: 'expose-loader?Robboscratch3_DeviceControlAPI'
                }
            ])
        }
    }),
